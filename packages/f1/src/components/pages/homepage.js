...
import HomeFirstSection from '../home_first_section/home_first_section.js';
import HomeAboutUs from '../home_about_us/home_about_us.js';
import SectionSecondOverlap from "../utils/section-second-overlap/SectionSecondOverlap";
import HomeDev from '../home_dev/home_dev';
import CooperationSection from '../cooperation_section/cooperation_section';

import SectionQuote from "../section-quote/SectionQuote";
import OurWorks from "../our_works/our_works";
...
const HomePage = ({ state, actions, libraries }) => {
  ...
  return data.isReady ? (        
    <Content>
      ...
      <HomeFirstSection data={homepage.home_first_section} handleScroll={handleScroll}/>
      <SectionSecondOverlap data={homepage.home_about_us} ref={childReference} />
      <HomeDev homepage={homepage} />
      <OurWorks page="home" />
      <CooperationSection data={homepage.cooperation_section} />
      <RecentPost title="Our blog"/>
      <SectionQuote />
