...
const Contact = ({ state, actions, libraries }) => {
  ...
  const contact = state.source[data.type][data.id];
  console.log(contact);
  ...
  return data.isReady  ? (
    <ArticleContainer>
      <div className="post-title">
        <Title dangerouslySetInnerHTML={{ __html: contact.title.rendered }} />
      </div>
      ...
      <div className="container">
        ...
        <ContactInfo data={contact.contact} contactForm={<Html2React html={contact.content.rendered} />}/>
